...
export default function EventsForm({
  ...
  return (
    <Form className='mb-2'>
      ...
      <Button variant='success' onClick={handlePlusKeyPoint} size='sm'>
        Tambah keypoint
      </Button>
      ...
      <div className='mb-3'>
        <Button variant='success' onClick={handlePlusTicket} size='sm'>
          Tambah Ticket
        </Button>
      </div>

      <Button disabled={isLoading} variant='primary' onClick={handleSubmit} loading={isLoading}>
        {edit ? 'Ubah' : 'Simpan'}
      </Button>
    </Form>
  );
